...
class DynamicFeatureLibrary:
    ...
    def _load_features_config(self, config_file):
        if config_file and os.path.exists(config_file):
            ...
            headwork_specific = {
                "A頭首工": [
                    "Dダム 全放流量", "E頭首工 右岸１取水量",  "E頭首工 右岸２取水量", "A頭首工 河川水位", 
                    "A頭首工 右岸取水量", "A頭首工 越流流量", "A頭首工 魚道流量", "A頭首工 取水量",
                    "E頭首工 取水量"
                ],
                "B頭首工": [
                    "Dダム 全放流量", "E頭首工 河川水位", "E頭首工 右岸１取水量",  "E頭首工 右岸２取水量", 
                    "A頭首工 河川水位", "A頭首工 右岸取水量", "F頭首工 河川水位",
                    "F頭首工 右岸取水量", "B頭首工 河川水位", "B頭首工 左岸取水量"
                ],
                "C頭首工": [
                    "G頭首工 河川水位", "G頭首工 左岸取水量", "H頭首工 河川水位",
                    "H頭首工 左岸取水量", "C頭首工 右岸取水量", "C頭首工 河川水位", "C頭首工 右岸取水量", 
                    "C頭首工 左岸取水量", "C頭首工 取水量", "H頭首工 取水量"
                ],
                "D頭首工": [
                    "Dダム 全放流量", "E頭首工 河川水位", "E頭首工 右岸１取水量",  "E頭首工 右岸２取水量", 
                    "A頭首工 河川水位", "A頭首工 右岸取水量", "F頭首工 河川水位",
                    "F頭首工 右岸取水量", "C頭首工 河川水位", "C頭首工 左岸取水量",
                    "G頭首工 河川水位", "G頭首工 左岸取水量", "H頭首工 河川水位", "H頭首工 左岸取水量", 
                    "H頭首工 右岸取水量", "C頭首工 河川水位", "C頭首工 右岸取水量", "C頭首工 左岸取水量", 
                    "D頭首工 河川水位", "D頭首工 左岸取水量",
                    "A頭首工 越流流量", "A頭首工 魚道流量", "A頭首工 取水量", "E頭首工 取水量",
                    "C頭首工 取水量", "H頭首工 取水量"
                ]
            }
    ...
    def prepare_headwork_data(self, headwork_name, input_file=None):
        ...
        if "A頭首工 河川水位" in df.columns:
            self.logger.info("Computing overflow discharge for A頭首工")
            df["A頭首工 越流流量"] = df["A頭首工 河川水位"].apply(
                lambda h: self.zenpukuseki(h - 0.5, 29.35, 2.1) + self.zenpukuseki(h, 10.85, 2.6)
            )
            df["A頭首工 魚道流量"] = df["A頭首工 河川水位"].apply(
                lambda h: self.zenpukuseki(h - 1.6, 0.6, 0.8) + self.zenpukuseki(h - 1.6, 1.4, 0.9)
            )

        if "E頭首工 右岸１取水量" in df.columns and "E頭首工 右岸２取水量" in df.columns:
            self.logger.info("Computing total intake for 小井口頭首工")
            df["E頭首工 取水量"] = df["E頭首工 右岸１取水量"] + df["E頭首工 右岸２取水量"]

        if {"A頭首工 右岸取水量", "A頭首工 越流流量", "A頭首工 魚道流量"}.issubset(df.columns):
            self.logger.info("Computing total intake for 別所頭首工")
            df["A頭首工 取水量"] = df["A頭首工 右岸取水量"] + df["A頭首工 越流流量"] + df["A頭首工 魚道流量"]

        if {"C頭首工 右岸取水量", "C頭首工 左岸取水量"}.issubset(df.columns):
            self.logger.info("Computing total intake for C頭首工")
            df["C頭首工 取水量"] = df["C頭首工 右岸取水量"] + df["C頭首工 左岸取水量"]

        if {"H頭首工 右岸取水量", "H頭首工 左岸取水量"}.issubset(df.columns):
            self.logger.info("Computing total intake for H頭首工")
            df["H頭首工 取水量"] = df["H頭首工 右岸取水量"] + df["H頭首工 左岸取水量"]
